...
##### quoted_a: Identifier by punctuation, after a governer
# e.g. <G> ... :/«/-/" ... <CL_HEAD>

# Root
quoted_a_0_0 = cl.Snippet("quoted_a_0_0")
quoted_a_0_0.pattern = '''pattern { e : G -> CL_HEAD ; CL_HEAD[!Quoted] ;
...
quoted_b_0_0.pattern = '''pattern { e : CL_HEAD -[1=parataxis]-> D ;
...
quoted_b = cl.DisjPat("quoted_b", root=quoted_b_0_0)

# Punctuation attached on the frame
quoted_b_1_0 = cl.Snippet("quoted_b_1_0")
quoted_b_1_0.pattern = '''pattern { G -[punct]-> P }'''

# Punctuation attached on the reported part
quoted_b_1_1 = cl.Snippet("quoted_b_1_1")
quoted_b_1_1.pattern = '''pattern { CL_HEAD -[punct]-> P }'''

# unambiguaous punctuation
quoted_b_2_0 = cl.Snippet("quoted_b_2_0")
quoted_b_2_0.pattern = '''pattern { P[lemma="»"] }'''

# preceeding "
quoted_b_2_1 = cl.Snippet("quoted_b_2_1")
quoted_b_2_1.pattern = '''pattern { P[lemma="\\\""] ;
\tP2 << P ; P2[lemma="\\\""] }'''

# additional comma
quoted_b_2_2 = cl.Snippet("quoted_b_2_2")
quoted_b_2_2.pattern = '''pattern { P < P2 ; P2[lemma=","] }'''
...
quoted_c_0_0.pattern = '''pattern { e : CL_HEAD -[1=parataxis]-> D ;
...
quoted_c = cl.DisjPat("quoted_c", root=quoted_c_0_0)

# Punctuation attached on the frame
quoted_c_1_0 = cl.Snippet("quoted_c_1_0")
quoted_c_1_0.pattern = '''pattern { G -[punct]-> P2 }'''

# Punctuation attached on the reported part
quoted_c_1_1 = cl.Snippet("quoted_c_1_1")
quoted_c_1_1.pattern = '''pattern { CL_HEAD -[punct]-> P2 }'''
...
quoted_d_0_0.pattern = '''pattern { e : G -> CL_HEAD ; CL_HEAD[!Quoted] }
...
quoted_d = cl.DisjPat("quoted_d", root=quoted_d_0_0)

# CL_HEAD annotated Title
quoted_d_1_0 = cl.Snippet("quoted_d_1_0")
quoted_d_1_0.pattern = '''pattern { CL_HEAD[Title="Yes"] }'''

# CL_HEAD annotated InTitle
quoted_d_1_1 = cl.Snippet("quoted_d_1_1")
quoted_d_1_1.pattern = '''pattern { CL_HEAD[InTitle="Yes"] }'''

quoted_d.add_snippets([quoted_d_1_0, quoted_d_1_1], quoted_d_0_0)



# quoted_e: parataxed parenthesis wit '(' and ')' or '--' and '--'

# Root
quoted_e_0_0 = cl.Snippet("quoted_e_0_0")
quoted_e_0_0.pattern = '''pattern { e : G -[1=parataxis]-> CL_HEAD ;
\tP1[lemma="--"|"("] ; P2[lemma="--"|")"] ;
...
quoted_e = cl.DisjPat("quoted_e", root=quoted_e_0_0)

# Two parentheses
quoted_e_1_0 = cl.Snippet("quoted_c_1_0")
quoted_e_1_0.pattern = '''pattern { P1[lemma="("] ; P2[lemma=")"] }'''

# Two '--'
quoted_e_1_1 = cl.Snippet("quoted_c_1_1")
quoted_e_1_1.pattern = '''pattern { P1[lemma="--"] ; P2[lemma="--"] }'''
