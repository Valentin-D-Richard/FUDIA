...
quoted_a_0_0.pattern = '''pattern { e : ANCHOR -> CL_HEAD ; CL_HEAD[!Quoted] ;
...
quoted_a_1_0.pattern = '''pattern { ANCHOR -[punct]-> P }'''
...
quoted_b_1_0.pattern = '''pattern { D -[punct]-> P }'''
...
quoted_d_0_0.pattern = '''pattern { e : ANCHOR -> CL_HEAD ; CL_HEAD[!Quoted] }
